...
describe EbayClient::Api do
  ...
  def success_response
    ...
    '<Version>967</Version><Build>E967_CORE_API_17785418_R1</Build></GeteBayOfficialTimeResponse></soapenv:Body></soapenv:Envelope>'
  end
  def failure_response
    '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">'+
        ...
        '</ErrorParameters></Errors><Version>967</Version><Build>E967_CORE_API_17785418_R1</Build></GeteBayOfficialTimeResponse></soapenv:Body></soapenv:Envelope>'
  end
  def recoverable_failure_response
    '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">'+
        ...
        '<LongMessage>Users of this application are limited to a number of calls they can make on a daily, hourly and 6-minute basis. You have gone over the daily limit. Please try again after 24 hours.</LongMessage><ErrorCode>218050</ErrorCode><SeverityCode>Error</SeverityCode></Errors><Version>967</Version>' +
        '<Build>E967_CORE_API_17785418_R1</Build></GeteBayOfficialTimeResponse></soapenv:Body></soapenv:Envelope>'
  end
end
